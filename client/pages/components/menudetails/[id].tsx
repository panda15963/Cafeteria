...
const ProductDetails = () => {
  ...
  const date = new Date();
  const tastingMap = product?.description.tasting_map;
  if (!product) {
    return <h1>Not Found</h1>;
  } else if (tastingMap){
    const average = (tastingMap?.acidity + tastingMap?.sweetness + tastingMap?.body + tastingMap?.flavor + tastingMap?.bitterness) / 5;
    return (
      <>
        <NavBar />
                        ...
                        <td>
                          <Progress
                            ...
                            classNames={{
                              ...
                              indicator: "bg-gradient-to-r from-yellow-400 to-yellow-800",
